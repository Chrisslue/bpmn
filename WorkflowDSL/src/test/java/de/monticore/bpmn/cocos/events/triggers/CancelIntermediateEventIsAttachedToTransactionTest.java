...
class CancelIntermediateEventIsAttachedToTransactionTest extends AbstractCoCoTest {
  ...
  void invalidTriggers() {
    ...
    Collection<Finding> expectedErrors = Lists.newArrayList(Finding.error(Messages.get("0xWFM2023",
        "E1")), Finding.error(Messages.get("0xWFM2023", "E2")), Finding.error(Messages.get(
            "0xWFM2023", "E3")));
