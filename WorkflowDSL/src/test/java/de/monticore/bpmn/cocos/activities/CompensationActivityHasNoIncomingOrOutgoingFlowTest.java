...
class CompensationActivityHasNoIncomingOrOutgoingFlowTest extends AbstractCoCoTest {
  ...
  void invalidSourcesAndTargets() {
    ...
    Collection<Finding> expectedErrors = Lists.newArrayList(Finding.error(Messages.get("0xWFM6001",
        "T1")), Finding.error(Messages.get("0xWFM6001", "T3")), Finding.error(Messages.get(
            "0xWFM6001", "T3")));
