...
class StartEventTopLevelProcessHasValidTriggerTest extends AbstractCoCoTest {
  ...
  void invalidTriggers() {
    ...
    Collection<Finding> expectedErrors = Lists.newArrayList(Finding.error(Messages.get("0xWFM2010",
        "E1")), Finding.error(Messages.get("0xWFM2010", "E2")), Finding.error(Messages.get(
            "0xWFM2010", "E3")), Finding.error(Messages.get("0xWFM2010", "E4")), Finding.error(
                Messages.get("0xWFM2010", "E5")));
