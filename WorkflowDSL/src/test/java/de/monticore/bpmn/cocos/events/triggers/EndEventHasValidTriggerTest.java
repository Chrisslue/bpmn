...
class EndEventHasValidTriggerTest extends AbstractCoCoTest {
  ...
  void invalidTriggers() {
    ...
    Collection<Finding> expectedErrors = Lists.newArrayList(Finding.error(Messages.get("0xWFM2012",
        "E1")), Finding.error(Messages.get("0xWFM2012", "E2")), Finding.error(Messages.get(
            "0xWFM2012", "E3")));
