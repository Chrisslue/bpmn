...
public class SequenceFlow {
  ...
  SequenceFlow(final ASTFlowElement source, final ASTFlowElement target,
  ...
  public ASTFlowElement getSource() { return source; }
  
  public ASTFlowElement getTarget() { return target; }
  
  public String getSourceName() { return getSource().getName(); }
  
  public String getTargetName() { return getTarget().getName(); }
  
  public List<ASTFlowCondition> getConditions() { return conditions; }
  ...
  public String getName() { return "From" + getSourceName() + "To" + getTargetName(); }
  ...
  public boolean deepEqualsWithComments(SequenceFlow flow) {
    ...
    return flow.getSource().deepEqualsWithComments(getSource()) && flow.getTarget()
        .deepEqualsWithComments(getTarget());
  }
