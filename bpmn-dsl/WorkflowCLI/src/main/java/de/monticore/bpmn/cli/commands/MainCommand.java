 ...
 */
@Command(name = "wftool", versionProvider = VersionProvider.class, synopsisSubcommandLabel = "COMMAND", subcommands = {
    CheckModelCommand.class }, mixinStandardHelpOptions = true, header = {
...
public class MainCommand implements Runnable {
  ...
  static final ImportStatement OCL_DEFAULT_TYPES_IMPORT = new ImportStatement(
      "de.monticore.workflow._types.ocl.DefaultTypes", true);
  ...
  @CommandLine.Option(names = { "-p",
      "--model-path" }, paramLabel = "DIR", description = "Path to model directory.", required = true)
  MCPath modelPath;
