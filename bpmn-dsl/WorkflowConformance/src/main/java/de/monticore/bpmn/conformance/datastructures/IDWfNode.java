...
public class IDWfNode implements WfNode {
  ...
  @Override
  public Set<IDWfNode> getPredecessors() { return predecessors; }
  
  @Override
  public Set<IDWfNode> getSuccessors() { return successors; }
  
  public IDWfNode(String label, NodeType nodeType, ASTStereotype stereotype, boolean isStart,
      boolean isEnd) {
  ...
  @Override
  public Optional<ASTStereotype> getStereotype() { return Optional.ofNullable(stereotype); }
  
  @Override
  public String getLabel() { return label; }
  
  public boolean isGateway() {
    return Set.of(NodeType.AND_SPLIT, NodeType.OR_SPLIT, NodeType.XOR_SPLIT, NodeType.OR_MERGE,
        NodeType.AND_MERGE, NodeType.XOR_MERGE).contains(nodeType);
  }
