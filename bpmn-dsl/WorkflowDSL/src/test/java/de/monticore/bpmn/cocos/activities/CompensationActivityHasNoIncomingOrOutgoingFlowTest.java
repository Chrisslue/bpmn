...
class CompensationActivityHasNoIncomingOrOutgoingFlowTest extends AbstractCoCoTest {
    ...
    void invalidSourcesAndTargets() {
        String modelName = "de.monticore.bpmn.cocos.activities.invalid.CompensationActivityHasNoIncomingOrOutgoingFlow";
    ...
    void validSourcesAndTargets() {
        String modelName = "de.monticore.bpmn.cocos.activities.valid.CompensationActivityHasNoIncomingOrOutgoingFlow";
