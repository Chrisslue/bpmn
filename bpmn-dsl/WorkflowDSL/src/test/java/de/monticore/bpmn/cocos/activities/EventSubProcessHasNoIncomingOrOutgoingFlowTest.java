...
public class EventSubProcessHasNoIncomingOrOutgoingFlowTest extends AbstractCoCoTest {
    ...
    void invalidSourcesAndTargets() {
        String modelName = "de.monticore.bpmn.cocos.activities.invalid.EventSubProcessHasNoIncomingOrOutgoingFlow";
    ...
    void validSourcesAndTargets() {
        String modelName = "de.monticore.bpmn.cocos.activities.valid.EventSubProcessHasNoIncomingOrOutgoingFlow";
