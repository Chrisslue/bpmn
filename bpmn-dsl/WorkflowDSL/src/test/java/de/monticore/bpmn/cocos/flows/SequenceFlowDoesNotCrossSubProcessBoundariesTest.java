...
class SequenceFlowDoesNotCrossSubProcessBoundariesTest extends AbstractCoCoTest {
    ...
    void invalidSourcesAndTargets() {
        String modelName = "de.monticore.bpmn.cocos.flows.invalid.SequenceFlowDoesNotCrossSubProcessBoundaries";
    ...
    void validSourcesAndTargets() {
        String modelName = "de.monticore.bpmn.cocos.flows.valid.SequenceFlowDoesNotCrossSubProcessBoundaries";
