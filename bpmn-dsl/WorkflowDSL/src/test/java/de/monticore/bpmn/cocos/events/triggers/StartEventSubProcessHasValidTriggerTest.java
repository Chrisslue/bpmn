...
class StartEventSubProcessHasValidTriggerTest extends AbstractCoCoTest {
    ...
    void invalidTriggers() {
        String modelName = "de.monticore.bpmn.cocos.events.triggers.invalid.StartEventSubProcessHasValidTrigger";
    ...
    @Test
    void validTriggers() {
        String modelName = "de.monticore.bpmn.cocos.events.triggers.valid.StartEventSubProcessHasValidTrigger";
