...
public class IntermediateEventHasOneOrMoreIncomingFlowsTest extends AbstractCoCoTest {
    ...
    void hasNoIncomingFlow() {
        String modelName = "de.monticore.bpmn.cocos.flows.invalid.IntermediateEventHasOneOrMoreIncomingFlows";

        Collection<Finding> expectedErrors = Lists.newArrayList(
                Finding.error(Messages.get("0xWFM2020", "E2"))
        );
    ...
    void hasIncomingFlow() {
        String modelName = "de.monticore.bpmn.cocos.flows.valid.IntermediateEventHasOneOrMoreIncomingFlows";
