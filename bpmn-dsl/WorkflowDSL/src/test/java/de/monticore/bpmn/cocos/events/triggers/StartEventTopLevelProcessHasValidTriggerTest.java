...
class StartEventTopLevelProcessHasValidTriggerTest extends AbstractCoCoTest {
    ...
    void invalidTriggers() {
        String modelName = "de.monticore.bpmn.cocos.events.triggers.invalid.StartEventTopLevelProcessHasValidTrigger";
    ...
    @Test
    void validTriggers() {
        String modelName = "de.monticore.bpmn.cocos.events.triggers.valid.StartEventTopLevelProcessHasValidTrigger";
