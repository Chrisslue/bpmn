...
class AtLeastOneStartEventIfEndEventIsUsedTest extends AbstractCoCoTest {
    ...
    void noStartEventUsed() {
        String modelName = "de.monticore.bpmn.cocos.events.invalid.AtLeastOneStartEventIfEndEventIsUsed";

        Collection<Finding> expectedErrors = Lists.newArrayList(
                Finding.error(Messages.get("0xWFM2006", "AtLeastOneStartEventIfEndEventIsUsed", "\"E1\"")),
