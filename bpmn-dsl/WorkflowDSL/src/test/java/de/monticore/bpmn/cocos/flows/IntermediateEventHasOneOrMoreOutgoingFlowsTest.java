...
public class IntermediateEventHasOneOrMoreOutgoingFlowsTest extends AbstractCoCoTest {
    ...
    void hasNoOutgoingFlow() {
        String modelName = "de.monticore.bpmn.cocos.flows.invalid.IntermediateEventHasOneOrMoreOutgoingFlows";

        Collection<Finding> expectedErrors = Lists.newArrayList(
                Finding.error(Messages.get("0xWFM2021", "E2"))
        );
    ...
    void hasOutgoingFlow() {
        String modelName = "de.monticore.bpmn.cocos.flows.valid.IntermediateEventHasOneOrMoreOutgoingFlows";
