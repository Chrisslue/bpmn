...
public class NonInterruptingEventIsSubProcessStartOrBoundaryTest extends AbstractCoCoTest {
    ...
    void isNeitherThrowNorCatch() {
        String modelName = "de.monticore.bpmn.cocos.events.invalid.NonInterruptingEventIsSubProcessStartOrBoundary";
    ...
    @Test
    void isThrowOrCatch() {
        String modelName = "de.monticore.bpmn.cocos.events.valid.NonInterruptingEventIsSubProcessStartOrBoundary";
