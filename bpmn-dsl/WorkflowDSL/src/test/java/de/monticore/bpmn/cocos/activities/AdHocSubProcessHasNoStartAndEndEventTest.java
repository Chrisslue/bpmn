...
class AdHocSubProcessHasNoStartAndEndEventTest extends AbstractCoCoTest {
    ...
    void hasStartOrEndEvents() {
        String modelName = "de.monticore.bpmn.cocos.activities.invalid.AdHocSubProcessHasNoStartAndEndEvent";
    ...
    void hasNoStartOrEndEvent() {
        String modelName = "de.monticore.bpmn.cocos.activities.valid.AdHocSubProcessHasNoStartAndEndEvent";
