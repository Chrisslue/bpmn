...
class IntermediateCatchEventHasValidTriggerTest extends AbstractCoCoTest {
  ...
  void invalidTriggers() {
    ...
    Collection<Finding> expectedErrors = Lists.newArrayList(Finding.error(Messages.get("0xWFM2013",
        "E1")), Finding.error(Messages.get("0xWFM2013", "E2")), Finding.error(Messages.get(
            "0xWFM2013", "E3")), Finding.error(Messages.get("0xWFM2013", "E4")), Finding.error(
                Messages.get("0xWFM2023", "E4")), Finding.error(Messages.get("0xWFM2013", "E5")),
