...
class EventGatewayDoesNotMixMessageEventsAndReceiveTasksTest extends AbstractCoCoTest {
    ...
    @Test
    void mixedTargets() {
        String modelName = "de.monticore.bpmn.cocos.gateways.invalid.EventGatewayDoesNotMixMessageEventsAndReceiveTasks";
    ...
    void nonMixedTargets() {
        String modelName = "de.monticore.bpmn.cocos.gateways.valid.EventGatewayDoesNotMixMessageEventsAndReceiveTasks";
