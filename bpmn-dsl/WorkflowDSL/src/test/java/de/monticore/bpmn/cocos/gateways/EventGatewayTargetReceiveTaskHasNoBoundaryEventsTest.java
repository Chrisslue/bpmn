...
class EventGatewayTargetReceiveTaskHasNoBoundaryEventsTest extends AbstractCoCoTest {
    ...
    void targetHasBoundaryEvents() {
        String modelName = "de.monticore.bpmn.cocos.gateways.invalid.EventGatewayTargetReceiveTaskHasNoBoundaryEvents";

        Collection<Finding> expectedErrors = Lists.newArrayList(
                Finding.error(Messages.get("0xWFM5009", "T3"))
        );
    ...
    void targetHasNoBoundaryEvents() {
        String modelName = "de.monticore.bpmn.cocos.gateways.valid.EventGatewayTargetReceiveTaskHasNoBoundaryEvents";
