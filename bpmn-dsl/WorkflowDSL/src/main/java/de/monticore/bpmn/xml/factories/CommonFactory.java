...
public class CommonFactory {
  ...
  // TODO
  //    public static JAXBElement<TDefinitions> makeDefinitions(final ASTWorkflowCompilationUnit
  // unit, final String name, final String targetNamespace) {
  //        JAXBElement<TDefinitions> xmlNode = create(factory::createTDefinition,
  ...
  public static JAXBElement<TSequenceFlow> makeXmlSequenceFlow(
      final SequenceFlow flow, final TFlowNode source, final TFlowNode target) {
    JAXBElement<TSequenceFlow> xmlNode =
        create(factory::createTSequenceFlow, factory::createSequenceFlow);
  ...
  public static JAXBElement<TAssociation> makeXmlAssociation(
      final QName source, final QName target) {
    JAXBElement<TAssociation> xmlNode =
        create(factory::createTAssociation, factory::createAssociation);
  ...
  public static JAXBElement<TDataObject> makeXmlDataObject(final ASTDataObject dataObject) {
    JAXBElement<TDataObject> xmlNode =
        create(factory::createTDataObject, factory::createDataObject);
  ...
  private static <V> JAXBElement<V> create(
      Supplier<V> supplier, Function<V, JAXBElement<V>> xmlFactory) {
