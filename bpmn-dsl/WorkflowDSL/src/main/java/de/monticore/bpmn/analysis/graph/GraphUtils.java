...
public class GraphUtils {
    ...
    public static Graph<ASTFlowNode, EndpointPair<ASTFlowNode>> processGraphFrom(final ASTFlowElementContainer container) {
        final ImmutableGraph<ASTFlowNode> graph = new WorkflowGraphConverter(container).convert().getGraph();
