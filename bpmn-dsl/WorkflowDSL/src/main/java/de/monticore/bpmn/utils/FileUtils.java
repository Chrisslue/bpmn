...
public class FileUtils {
  ...
  public static File createFile(final Path path, final String name, final String extension)
      throws IOException {
  ...
  public static File createTempFile(final String prefix, final String extension)
      throws IOException {
