...
public class LoopCharacteristicsFactory
    extends XmlFactory<ASTLoopCharacteristics, TLoopCharacteristics>
  ...
  public static JAXBElement<? extends TLoopCharacteristics> from(
      final ASTLoopCharacteristics loopCharacteristics) {
    return new LoopCharacteristicsFactory().buildXml(loopCharacteristics);
  }

  @Override
  public JAXBElement<? extends TLoopCharacteristics> buildXml(
      final ASTLoopCharacteristics loopCharacteristics) {
  ...
  public void visit(final ASTStandardLoop loop) {
    TStandardLoopCharacteristics t =
        create(
            factory::createTStandardLoopCharacteristics,
            factory::createStandardLoopCharacteristics);
  ...
  public void visit(final ASTMILoop loop) {
    TMultiInstanceLoopCharacteristics t =
        create(
            factory::createTMultiInstanceLoopCharacteristics,
            factory::createMultiInstanceLoopCharacteristics);
