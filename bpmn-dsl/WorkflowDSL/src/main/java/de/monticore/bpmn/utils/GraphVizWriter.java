...
public class GraphVizWriter {
    ...
    /**
     * Sets a timeout. When this timeout is reached, the system process executing GraphViz is terminated.
     *
    ...
    private GraphVizWriter generate(final OutputFormat format) throws IOException {
        ...
        try {
            new ProcessExecutor()
                    .command("dot", fileTypeArgument, dotFile.getAbsolutePath(), "-o", imageFile.getAbsolutePath())
                    .destroyOnExit()
