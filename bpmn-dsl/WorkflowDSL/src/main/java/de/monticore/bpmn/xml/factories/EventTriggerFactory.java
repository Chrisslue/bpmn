...
public class EventTriggerFactory implements WorkflowVisitor2, WorkflowHandler {
  ...
  public static List<JAXBElement<? extends TEventDefinition>> makeXml(
  ...
  public void visit(final ASTEventTriggerCompensate trigger) {
    TCompensateEventDefinition t =
        createTrigger(
            factory::createTCompensateEventDefinition, factory::createCompensateEventDefinition);
    if (trigger.isAsync()) {
  ...
  public void visit(final ASTEventTriggerConditional trigger) {
    createTrigger(
        factory::createTConditionalEventDefinition, factory::createConditionalEventDefinition);
    // TODO condition
    /*
  ...
  public void visit(final ASTEventTriggerEscalate trigger) {
    createTrigger(
        factory::createTEscalationEventDefinition, factory::createEscalationEventDefinition);
    // TODO escalation ref
  }
  ...
  public void visit(final ASTEventTriggerTerminate trigger) {
    createTrigger(
        factory::createTTerminateEventDefinition, factory::createTerminateEventDefinition);
  }
  ...
  protected void buildTimerExpression(
      final Consumer<TFormalExpression> target, final String content) {
    TFormalExpression t = CommonFactory.buildXmlFormalExpression();
    t.getContent().add(content);
    target.accept(t);
  }

  protected <V extends TEventDefinition> V createTrigger(
