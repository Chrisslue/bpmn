...
public class LoLaChecker {
    ...
    /**
     * Sets the input file containing the Petri net to be checked. The Petri net must be in the LoLA format.
     *
    ...
    public LoLaChecker check() throws IOException, InterruptedException, TimeoutException {
        ...
        parameter("search", "cover"); // use coverability graph instead of reachability graph (depth-first search may fail if petri-net is unbounded)
