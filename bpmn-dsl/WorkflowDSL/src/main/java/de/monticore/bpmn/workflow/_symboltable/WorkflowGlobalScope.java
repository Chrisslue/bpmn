...
public class WorkflowGlobalScope extends WorkflowGlobalScopeTOP {
  ...
  public void init() {
    ...
    this.putSymbolDeSer(
        "de.monticore.cd4codebasis._symboltable.CDMethodSignatureSymbol", new MethodSymbolDeSer());
    this.putSymbolDeSer(
        "de.monticore.cdassociation._symboltable.CDRoleSymbol", new FieldSymbolDeSer());
  }
}
