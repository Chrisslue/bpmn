    ...
    public void check(final ASTWFTask task) {
        if(task.getType() == ASTConstantsWorkflow.SERVICE){
            if(task.isPresentTaskTypeAttributes()) {
                if (!task.hasSpecifiedAttributeWebservice() || task.getTaskTypeAttributes().isPresentMessage()) {
            ...
            if(task.isPresentTaskTypeAttributes()) {
                if (!task.getTaskTypeAttributes().isPresentMessage() || !task.getTaskTypeAttributes().isPresentOperation()) {
            ...
            if(task.isPresentTaskTypeAttributes()) {
                if (!task.hasSpecifiedAttributeWebservice() || task.getTaskTypeAttributes().isPresentOperation() || task.getTaskTypeAttributes().isPresentMessage()) {
