...
public class WorkflowParser extends WorkflowParserTOP {
     ...
     */
    /**
     * Parses the model file and checks that the process name matches the filename and that the package declaration
     * matches the location of the model file (relative to the model path root).
     *
