...
public class WorkflowCollectors {
  ...
  public static List<ASTFlowElement> toFlowElementsLocal(final ASTWFProcess root) {
    WorkflowLocalCollector<ASTFlowElement> collector = new WorkflowLocalCollector<ASTFlowElement>(
        root) {
  ...
  public static List<ASTWFActivity> toActivities(final ASTWFProcess root) {
    WorkflowCollector<ASTWFActivity> collector = new WorkflowCollector<ASTWFActivity>(root) {
  ...
  public static List<ASTWFActivity> toActivitiesLocal(final ASTWFProcess root) {
    WorkflowLocalCollector<ASTWFActivity> collector = new WorkflowLocalCollector<ASTWFActivity>(
        root) {
  ...
  public static List<ASTWFSubProcess> toSubProcesses(final ASTWFProcess root) {
    WorkflowCollector<ASTWFSubProcess> collector = new WorkflowCollector<ASTWFSubProcess>(root) {
  ...
  public static List<ASTWFSubProcess> toSubProcessesLocal(final ASTWFProcess root) {
    WorkflowLocalCollector<ASTWFSubProcess> collector = new WorkflowLocalCollector<ASTWFSubProcess>(
        root) {
  ...
  public static List<ASTWFCallActivity> toCallActivities(final ASTWFProcess root) {
    WorkflowCollector<ASTWFCallActivity> collector = new WorkflowCollector<ASTWFCallActivity>(
        root) {
  ...
  public static List<ASTWFTask> toTasks(final ASTWFProcess root) {
    WorkflowCollector<ASTWFTask> collector = new WorkflowCollector<ASTWFTask>(root) {
  ...
  public static List<ASTWFTask> toTasksLocal(final ASTWFProcess root) {
    WorkflowLocalCollector<ASTWFTask> collector = new WorkflowLocalCollector<ASTWFTask>(root) {
  ...
  public static List<ASTWFGateway> toGateways(final ASTWFProcess root) {
    WorkflowCollector<ASTWFGateway> collector = new WorkflowCollector<ASTWFGateway>(root) {
  ...
  public static List<ASTWFGateway> toGatewaysLocal(final ASTWFProcess root) {
    WorkflowLocalCollector<ASTWFGateway> collector = new WorkflowLocalCollector<ASTWFGateway>(
        root) {
  ...
  public static List<ASTWFEvent> toEvents(final ASTWFProcess root) {
    WorkflowCollector<ASTWFEvent> collector = new WorkflowCollector<ASTWFEvent>(root) {
  ...
  public static List<ASTWFEvent> toEventsLocal(final ASTWFProcess root) {
    return root.getFlowElementList().stream().filter(elem -> elem instanceof ASTWFEvent).map(
        elem -> (ASTWFEvent) elem).collect(Collectors.toList());
  }
  ...
  public static List<ASTWFDataObject> toDataObjects(final ASTWFProcess root) {
    WorkflowCollector<ASTWFDataObject> collector = new WorkflowCollector<ASTWFDataObject>(root) {
  ...
  public static List<ASTWFDataObject> toDataObjectsLocal(final ASTWFProcess root) {
    WorkflowLocalCollector<ASTWFDataObject> collector = new WorkflowLocalCollector<ASTWFDataObject>(
        root) {
  ...
  public static List<ASTWFTask> toUserTasks(final ASTWFProcess root) {
    return WorkflowCollectors.toTasks(root).stream().filter(task -> task.getType()
        == ASTConstantsWorkflow.USER).collect(Collectors.toList());
  }
  
  public static List<ASTWFTask> toServiceTasks(final ASTWFProcess root) {
    return WorkflowCollectors.toTasks(root).stream().filter(task -> task.getType()
        == ASTConstantsWorkflow.SERVICE).collect(Collectors.toList());
  }
  
  public static List<ASTFlowElement> toStartNodesLocal(final ASTWFProcess root) {
    return WorkflowCollectors.toFlowNodesLocal(root).stream().filter(
        ASTFlowElement::isEmptyIncomings).collect(Collectors.toList());
  }
  
  public static List<ASTFlowElement> toEndNodesLocal(final ASTWFProcess root) {
    return WorkflowCollectors.toFlowNodesLocal(root).stream().filter(
        ASTFlowElement::isEmptyOutgoings).collect(Collectors.toList());
  }
  
  public static List<ASTWFEvent> toStartEventsLocal(final ASTWFProcess root) {
    return WorkflowCollectors.toEventsLocal(root).stream().filter(ASTWFEvent::isStart).collect(
        Collectors.toList());
  }
  
  public static List<ASTWFEvent> toStartEventsLocalSubProcess(final ASTWFSubProcess root) {
    return WorkflowCollectors.toEventsLocalSubProcess(root).stream().filter(ASTWFEvent::isStart)
        .collect(Collectors.toList());
  }
  
  public static List<ASTWFEvent> toEndEventsLocalSubProcess(final ASTWFSubProcess root) {
    return WorkflowCollectors.toEventsLocalSubProcess(root).stream().filter(ASTWFEvent::isEnd)
        .collect(Collectors.toList());
  }
  
  public static List<ASTWFEvent> toEndEventsLocal(final ASTWFProcess root) {
    return WorkflowCollectors.toEventsLocal(root).stream().filter(ASTWFEvent::isEnd).collect(
        Collectors.toList());
  }
  ...
  public static List<SequenceFlow> toSequenceFlowLocal(final ASTWFProcess root) {
    ...
    return Streams.concat(flowNodes.stream().map(ASTFlowElement::getIncomingsList).flatMap(
        List::stream), flowNodes.stream().map(ASTFlowElement::getOutgoingsList).flatMap(
