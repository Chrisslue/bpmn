...
public class ASTWFGateway extends ASTWFGatewayTOP {
  
  public boolean isConverging() { return getDirection() == ASTConstantsWorkflow.MERGE; }
  
  public boolean isDiverging() { return getDirection() == ASTConstantsWorkflow.SPLIT; }
