 ...
 * Page: 241
 * Description: The same Event types as for boundary Events are allowed, namely: Message, Timer, Escalation, Error, Compensation, Conditional, Signal, Multiple, and Parallel.
 */
public class StartEventSubProcessHasValidTrigger extends AbstractHasValidTriggerCoCo implements WorkflowASTSubProcessCoCo {
    ...
    public void check(final ASTSubProcess subProcess) {
        if (subProcess.isTriggeredByEvent()) {
            WorkflowCollectors.toEventsLocal(subProcess)
                    .stream()
