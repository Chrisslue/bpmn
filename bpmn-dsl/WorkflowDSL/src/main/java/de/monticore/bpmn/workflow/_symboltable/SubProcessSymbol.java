...
public class SubProcessSymbol extends SubProcessSymbolTOP {

    private IOSpecification ioSpecification;

    public SubProcessSymbol(final String name) {
        super(name);
    }

    public SubProcessSymbol(final String name, final IOSpecification ioSpecification) {
        super(name);
