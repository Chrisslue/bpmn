...
Download the latest distribution of LoLA from the [official website](http://service-technology.org/lola/) (direct donwload form [here](http://service-technology.org/files/lola/lola-2.0.tar.gz)).
