...
public class DefaultSequentialInterleaving {
  ...
  /**
   * Create the sub-lts induced by the startTransition. We want startTransition to be in the sub-lts but no other
   * transition outgoing from startTransition.getSource().
   */
