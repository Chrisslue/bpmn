...
public class CheckResult {
  ...
  public String printWitness() {
    return branchId.get().getNodeList().stream().filter(node -> !node.getNodeType().isGateway())
  ...
  public Optional<BranchID> getBranchId() { return branchId; }
  
  public Result getResult() { return result; }
  
  public WfNode getNode() { return node; }
  
  public boolean isConform() { return result == Result.CONFORM; }
  
  public boolean isNonConform() { return result == Result.NON_CONFORM; }
