...
package de.monticore.bpmn.conformance.predicate;
...
class PredicateTest extends AbstractConfTest {
  ...
  private final String modelDir = "de.monticore.bpmn.conformance.predicate.";
  ...
  static Stream<Arguments> xorSplitSource() {
    return Stream.of(Arguments.of(List.of("T1"), true), Arguments.of(List.of("T2"), true), Arguments
        .of(List.of("T3"), true), Arguments.of(List.of("T4"), true), Arguments.of(List.of("T1",
            "S"), true), Arguments.of(List.of("S", "T2"), true), Arguments.of(List.of("S", "T2"),
                true), Arguments.of(List.of("T1", "T2"), false), Arguments.of(List.of("T1", "T2",
                    "S"), false), Arguments.of(List.of("T1", "S"), true), Arguments.of(List.of("T1",
                        "T3", "XOR1"), false), Arguments.of(List.of("T1", "T3", "T3", "T4"), false),
  ...
  static Stream<Arguments> orSource() {
    return Stream.of(Arguments.of(List.of("T1"), true), Arguments.of(List.of("T2"), true), Arguments
        .of(List.of("T1", "T2"), true), Arguments.of(List.of("T1", "S"), true), Arguments.of(List
            .of("S"), false), Arguments.of(List.of("T2", "S"), true), Arguments.of(List.of("T2",
                "T3"), true), Arguments.of(List.of("T2", "T2", "T3", "T4"), true), Arguments.of(List
                    .of("T3", "T4"), true), Arguments.of(List.of("T1", "T3", "T4"), true), Arguments
                        .of(List.of("T2", "T3", "T4"), true), Arguments.of(List.of("T2", "T4"),
                            true));
  }
  ...
  static Stream<Arguments> loopSource() {
    return Stream.of(Arguments.of(List.of("T"), true), Arguments.of(List.of("T", "END"), false),
  ...
  static Stream<Arguments> andSource() {
    return Stream.of(Arguments.of(List.of("T1"), false), Arguments.of(List.of("T2"), false),
        Arguments.of(List.of("T1", "T2"), false), Arguments.of(List.of("T1", "S"), false), Arguments
            .of(List.of("S", "T2"), false), Arguments.of(List.of("T2"), false), Arguments.of(List
                .of("T1", "T2"), false), Arguments.of(List.of("T1", "S"), false), Arguments.of(List
                    .of("T2", "S"), false), Arguments.of(List.of("T1", "T2", "T3", "T4"), true),
  ...
  static Stream<Arguments> complexSource() {
    return Stream.of(Arguments.of(List.of("T1"), true), Arguments.of(List.of("T2"), true), Arguments
        .of(List.of("T4"), true), Arguments.of(List.of("T4", "T2"), true), Arguments.of(List.of(
            "T5", "T3"), true), Arguments.of(List.of("T1", "T5", "T3"), false), Arguments.of(List
                .of("T4", "T5", "T3"), false), Arguments.of(List.of("T1", "T4"), false));
  }
