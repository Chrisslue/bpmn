...
class WfConformanceCheckerTest extends AbstractConfTest {
  ...
  private final String modelDir = "de.monticore.bpmn.conformance.conformance.";
  
  public static Stream<Arguments> xorConformance() {
    return Stream.of(Arguments.of("Conform1", true, Map.of("T1", CONFORM, "S", CONFORM)), Arguments
        .of("Conform2", true, Map.of("T1", CONFORM, "T2", CONFORM, "S", CONFORM)), Arguments.of(
            "NonConform1", false, Map.of("S", NON_CONFORM)), Arguments.of("NonConform2", false, Map
                .of("T1", CONFORM, "T2", CONFORM, "T3", CONFORM, "S", NON_CONFORM)));
  }
  ...
  public void testConformanceWithXorGateway(String input, boolean expected,
      Map<String, CheckResult.Result> nodes) {
    
    // given
    reference = loadBPMN(modelDir + "xor.Reference", true);
    concrete = loadBPMN(modelDir + "xor." + input, true);
  ...
  public void test() {
    ...
    Map<String, CheckResult.Result> conformanceMap = (Map<String, CheckResult.Result>) params[2]; // Index 2
