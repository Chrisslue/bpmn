...
The TimeManagement.cd [file] with the exception that the TimeSlotList class is missing.
...
The symbol TimeSlotList cannot be found. This serves to confirm two things at the same time:
